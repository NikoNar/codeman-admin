...
<div class="col-md-9 border-right">
		...
		<div class="form-group">
			<div class="col-md-12 no-padding">
				...
				<div class='input-group'>
					...
					@else
						{!! Form::text('slug', null, ['class' => 'form-control', 'readonly', 'disabled']) !!}
					@endif
				</div>
			</div>
		</div>
	...
	{{-- <div class="clearfix"></div> --}}
		@include('admin-panel::shop.variations.parts.forms.components.variation_details')
	{{-- <div class="clearfix"></div> --}}
