<form id="listing-filter">
	...
	<input type="hidden" name="model" id="model" value="\App\Models\Product" >
    ...
    <div class="col-md-2 pull-right no-padding" style="margin-left: 15px;">
            <select name="search_by" id="search_by" class="form-control">
                ...
                {{-- <option value="billing_first_name" {!! request()->has('search_by') && request()->get('search_by') == 'billing_first_name' ? 'selected' : '' !!}>Search By Name</option> --}}
