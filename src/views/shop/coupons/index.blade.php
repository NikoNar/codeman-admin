	...
	<div class="box">
	    <div class="box-body">
    		...
    		<div id="resource-container">
    			@include('admin-panel::shop.coupons.parts.listing')
    		</div>
			<input type="hidden" name="modelName" id="modelName" value="\Codeman\Admin\Models\Shop\Coupon" >
	    </div>
	    <!-- /.box-footer-->
	</div>
@endsection
	    ...
	    $(document).ready(function() {
	        ...
	        var dataTable = $('#ajax-table').DataTable( {
	            ...
	            columns: [
					...
					{   data: 'usage_limit', render: function(data){
		                    return data;
						},
						orderable: false,
	                },
	                { 	data: 'items_usage_limit', render: function(data){
							return data;
	                	} 
					},
					{ 	data: 'user_usage_limit', render: function(data){
	                    	return data;
	                	} 
					},
					{ 	data: 'creator_id', render: function(data){
	                    	return data;
	                	} 
					},
					{ 	data: 'min_spend_amount', render: function(data){
	                    	return data;
	                	} 
					},
					{ 	data: 'max_spend_amount', render: function(data){
	                    	return data;
	                	} 
					},
