	...
	<div class="box">
	    <div class="box-body">
	    	...
	    	<div class="col-md-8 no-padding pull-right">
	    		<a href="{{ route('vendor.create') }}" class="btn btn-primary btn-flat  btn-medium pull-right">Create New vendor</a>
    		...
    		<div id="resource-container">
    			@include('admin-panel::vendor.parts.listing')
    		</div>

			<input type="hidden" name="modelName" id="modelName" value="{!! isset($vendors) && !$vendors->isEmpty() ? class_basename($vendors[0]) : null !!}" >
