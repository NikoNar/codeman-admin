...
{{--                    <div class="info-box ">--}}
{{--                        <a href="#">--}}
{{--                            <span class="info-box-icon bg-red"><i class="fas fa-concierge-bell"></i></span>--}}
{{--                        </a>--}}
...
{{--                      </span>--}}
{{--                            <a href="#" class="small-box-footer info-box-text"--}}
{{--                               style="position: absolute;right: 30px; bottom: 30px;">View all <i--}}
{{--                                        class="fa fa-arrow-circle-right"></i></a>--}}
{{--                        </div>--}}
{{--                        <!-- /.info-box-content -->--}}
...
{{--                      <span class="info-box-number">10</span></span>--}}
{{--                        </div>--}}
{{--                        <a href="#" class="small-box-footer info-box-text"--}}
{{--                           style="position: absolute;right: 30px; bottom: 30px;">View all <i--}}
{{--                                    class="fa fa-arrow-circle-right"></i></a>--}}
...
{{--                    <div class="info-box">--}}
{{--                        <a href="#">--}}
{{--                            <span class="info-box-icon bg-aqua"><i class="fas fa-handshake"></i></span>--}}
{{--                        </a>--}}
{{--                        <div class="info-box-content">--}}
