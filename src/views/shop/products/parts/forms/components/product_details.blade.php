...
<div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
    	...
    	<li class="d-none p-variations-tab"><a href="#variations" data-toggle="tab" aria-expanded="false">Variations</a></li>
    </ul>
    	...
    	<div class="tab-pane" id="variations">
    		@if(isset($resource) && !empty($resource))
            	<div class="form-group">
        			<div class="row">
	            		<div class="col-md-3">
	        				{!! Form::label('generate_variations_option', 'Create variations') !!}
	            		</div>
	            		<div class="col-md-5">
		                    <select name="generate_variations_option" id="generate_variations_option" class="form-control select2">
								<option value="all">Create variations from all attributes</option>
		                    </select>
	            		</div>
	            		<div class="col-md-4">
		        			<button class="btn btn-primary btn-flat" id="generate_variations_button" type="button" data-product-id="{{ $resource->id }}">Add</button>
	            		</div>
	            		<div class="clearfix"></div>
        			</div>
        		</div>
        		<div class="options-container">
        			@if(isset($options_grouped) && !empty($options_grouped))
						@include('admin-panel::shop.products.parts.variations.item', [
        	...
        	@else
        		<h5 class="text-muted">For generating Variations you need to Publish this Product</h5>
        	@endif
    	</div>
    	<!-- /.tab-pane -->
    </div>
